...
app = FastAPI(title="OncoTwin DataHub Mission Control", version="10.1.0")
app.add_middleware(
    CORSMiddleware,
...
async def datahub_capabilities() -> dict[str, Any]:
    ...
    return {
        ...
        "agent_context_kit": {"framework": "LangChain", "llm": "Google Gemini / Vertex AI"},
        "analytics_agent_url": settings.analytics_agent_url,
...
async def datahub_observatory(case_id: str = "feature_quality") -> dict[str, Any]:
    ...
    return {
        ...
        "truth_boundary": {
            ...
            "catalog_coverage": "7/7 canonical DataHub assets",
...
async def approve_mission(mission_id: str, request: MissionApprovalRequest) -> dict[str, Any]:
    ...
    # Every V10 mission has a dedicated DataHub dataset. Feature quality performs
    ...
    if not settings.demo_mode:
        ...
        incident_title = f"OncoTwin V10 · {spec['title']}"
